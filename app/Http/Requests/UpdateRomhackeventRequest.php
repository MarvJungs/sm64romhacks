...
class UpdateRomhackeventRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'description' => 'exclude_if:external,true|required|array',
            'description.blocks' => 'exclude_if:external,true|required|array|min:1',
            'description.time' => 'exclude_if:external,true|required|numeric',
            'description.version' => 'exclude_if:external,true|required|string',
