<x-layout>
    ...
    <form id="manageVersion" method="post" enctype="multipart/form-data">
        @csrf
        <h1 class="text-decoration-underline">Add Version for: {{ $hack->name }}</h1>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control @error('version.starcount') is-invalid @enderror"
                name="version[starcount]" value="{{ old('version.starcount') }}">
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="date" class="form-control @error('version.releasedate') is-invalid @enderror"
                name="version[releasedate]" value="{{ old('version.releasedate') }}">
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="file" class="form-control @error('version.filename') is-invalid @enderror"
                name="version[filename]" value="{{ old('version.filename') }}">
        </div>
        ...
        <div class="mb-3">
            <div class="form-check">
                ...
                <input class="form-check-input @error('version.demo') is-invalid @enderror" type="checkbox"
                    value="1" name="version[demo]" @if (old('version.demo')) checked @endif>
            ...
            <div class="form-check">
                ...
                <input class="form-check-input @error('version.recommened') is-invalid @enderror" type="checkbox"
                    value="1" name="version[recommened]" @if (old('version.recommened')) checked @endif>
