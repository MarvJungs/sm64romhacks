    ...
    <form class="row g-3" method="post" id="manageEvent">
        ...
        <div class="col-12">
            <div class="form-check">
                ...
                <input class="form-check-input" type="checkbox" name="external" value="1" {{ $event->external ? 'checked' : '' }}>
        ...
        <input type="hidden" id="description" name="description" value="{{ old('description') ?? json_encode($event->description) }}" />
        <div class="col-12">
