        ...
        <fieldset class="row g-3 mb-3">
            ...
            <div class="col-10">
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="type" id="standalone" value="standalone" checked>
        ...
        <div class="row g-3 mb-3" id="videolinks" data-enable-multiple-fields="true">
            <div class="row g-2 mb-2">
                ...
                @if (old('videolink') === null)
                    <div class="col-9">
                        <input class="form-control mb-2" type="url" name="videolink[]" required>
                    </div>
                    <div class="col-1">
                        <button type="button" class="btn btn-danger" disabled><x-bi-trash-fill /></button>
                    </div>
                @else
                    @foreach (old('videolink') as $index => $videolink)
                        ...
                        <div class="@if ($index > 0) offset-2 @endif col-9">
                            <input class="form-control mb-2 @error("videolink.$index") is-invalid @enderror"
                                type="url" name="videolink[]" value="{{ old("videolink.$index") }}" required>
