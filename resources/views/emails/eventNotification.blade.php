                                    ...
                                    <tr>
                                        <td align="center"
                                            ...
                                            <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="width:250px;"><img alt="logo" height="auto"
                                                                src="https://www.sm64romhacks.com/_assets/_img/logo.png"
                                        ...
                                        <td align="left"
                                            ...
                                            <div
                                                ...
                                                <p>Today we are informing you that a new event has been created which we
                                                    are looking forward to pull through! Here are some key dates:</p>
                                                <ul>
                                                    <li>Name: {{ $event->name }}</li>
                                                    <li>Starts at: {{ $event->start_utc }}</li>
                                                    <li>Ends at: {{ $event->end_utc }}</li>
                                                    <li>
                                                    ...
                                                    @if ($event->marathon)
                                                        <li>
                                                            Location: <a href="http://www.twitch.tv/sm64romhacks"
                                                                style="color: #00bc8c">The
                                                                sm64romhacks Twitch Channel</a>
                                                        </li>
                                                    @endif
                                                </ul>
                                                <p>Mark the dates down in your calendar now! We look forward to see you
                                                    there.</p>
                                                <p>You can find the most up-to-date Information always on the <a
                                                        href="http://www.sm64romhacks.com/events/{{ $event->slug }}"
                                                        style="color: #00bc8c">corresponding
                                                        event page</a></p>
                                            </div>
                                        </td>
                                    </tr>
                                                ...
                                                <tr>
                                                    <td style="padding:4px;">
                                                        <table border="0" cellpadding="0" cellspacing="0"
                                                            role="presentation"
                                                            style="background:#5266ef;border-radius:3px;width:20px;">
                                                            <tr>
                                                                <td
                                            ...
                                            <table align="center" border="0" cellpadding="0" cellspacing="0"
                                                ...
                                                <tr>
                                                    <td style="padding:4px;">
                                                        <table border="0" cellpadding="0" cellspacing="0"
                                                            role="presentation"
                                                            style="background:#9146ff;border-radius:3px;width:20px;">
                                                            <tr>
                                                                <td
                                                                    style="font-size:0;height:20px;vertical-align:middle;width:20px;">
                                                    ...
                                                    <td style="padding:4px;">
                                                        <table border="0" cellpadding="0" cellspacing="0"
                                                            ...
                                                            <tr>
                                                                <td
                                                                    style="font-size:0;height:20px;vertical-align:middle;width:20px;">
                                                                    <a href="https://www.youtube.com/@sm64romhacks28"
                                                                        target="_blank"><img height="20"
                                                    ...
                                                    <td style="padding:4px;">
                                                        <table border="0" cellpadding="0" cellspacing="0"
                                                            ...
                                                            <tr>
                                                                <td
                                                                    style="font-size:0;height:20px;vertical-align:middle;width:20px;">
                                                                    <a href="https://x.com/sm64romhacks"
                                                                        target="_blank"><img height="20"
                                            ...
                                            <table align="center" border="0" cellpadding="0" cellspacing="0"
                                                ...
                                                <tr>
                                                    <td style="padding:4px;">
                                                        <table border="0" cellpadding="0" cellspacing="0"
                                                            role="presentation"
                                                            style="background:#00b9fe;border-radius:3px;width:20px;">
                                                            <tr>
                                                                <td
                                                                    style="font-size:0;height:20px;vertical-align:middle;width:20px;">
                                                                    <a href="https://twitch.tv/sm64romhacks"
                                        ...
                                        <td align="left"
                                            ...
                                            <div
                                                ...
                                                <p>With Kind Regards<br>Your sm64romhacks Team</p><a
                                                    href="mailto:info@sm64romhacks.com">info@sm64romhacks.com</a><br><a
                                                    href="https://www.sm64romhacks.com">https://www.sm64romhacks.com</a>
                                            </div>
                                        </td>
                                    </tr>
                                </table>
