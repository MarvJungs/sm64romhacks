			...
			<div align="center">
				...
				<ol>
					<table>
						...
						<tr align="left"><td><li>Select the bps-Patch you want to apply (it may also be a .zip file with the .bps file in it)</li></td></tr>
						<tr align="left"><td><li>Press on "Apply Patch"</li></td></tr>
